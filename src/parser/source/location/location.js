import dayParser from '@/parser/source/location/help/day';
import lessonParser from '@/parser/source/location/help/lesson';
import contentParser from '@/parser/source/location/help/content';
import headerParser from '@/parser/source/location/help/header';
...
export default class locationScheduleParser {
  ...
  addContent(Content) {
    this.result[this.index].lessons[this.lessonsIndex].content.push(Content.object);
  }
